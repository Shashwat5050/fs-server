...
type InstallAndExtractFileRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Url              string `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	InstallationPath string `protobuf:"bytes,2,opt,name=installationPath,proto3" json:"installationPath,omitempty"`
	DisableCache     bool   `protobuf:"varint,3,opt,name=disableCache,proto3" json:"disableCache,omitempty"`
}

func (x *InstallAndExtractFileRequest) Reset() {
	*x = InstallAndExtractFileRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fs_manager_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *InstallAndExtractFileRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstallAndExtractFileRequest) ProtoMessage() {}

func (x *InstallAndExtractFileRequest) ProtoReflect() protoreflect.Message {
	mi := &file_fs_manager_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstallAndExtractFileRequest.ProtoReflect.Descriptor instead.
func (*InstallAndExtractFileRequest) Descriptor() ([]byte, []int) {
	return file_fs_manager_proto_rawDescGZIP(), []int{21}
}

func (x *InstallAndExtractFileRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *InstallAndExtractFileRequest) GetInstallationPath() string {
	if x != nil {
...
func (x *InstallAndExtractFileRequest) GetDisableCache() bool {
	if x != nil {
...
func (x *UninstallServerRequest) Reset() {
	*x = UninstallServerRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fs_manager_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UninstallServerRequest) Descriptor() ([]byte, []int) {
	return file_fs_manager_proto_rawDescGZIP(), []int{22}
}

func (x *UninstallServerRequest) GetServerName() string {
	if x != nil {
		return x.ServerName
	}
	return ""
...
func (x *GetDiskSpaceRequest) Reset() {
	*x = GetDiskSpaceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fs_manager_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetDiskSpaceRequest) Descriptor() ([]byte, []int) {
	return file_fs_manager_proto_rawDescGZIP(), []int{23}
}

func (x *GetDiskSpaceRequest) GetServerName() string {
	if x != nil {
		return x.ServerName
	}
	return ""
...
func (x *GetDiskSpaceResponse) Reset() {
	*x = GetDiskSpaceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fs_manager_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetDiskSpaceResponse) Descriptor() ([]byte, []int) {
	return file_fs_manager_proto_rawDescGZIP(), []int{24}
}

func (x *GetDiskSpaceResponse) GetServerName() string {
	if x != nil {
		return x.ServerName
	}
	return ""
...
func (x *GetDiskSpaceResponse) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
var file_fs_manager_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x22, 0x35, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x44, 0x69, 0x73, 0x6b, 0x53, 0x70, 0x61, 0x63,
	...
	0x72, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x4a, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x44,
	0x69, 0x73, 0x6b, 0x53, 0x70, 0x61, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x73, 0x69, 0x7a, 0x65, 0x32, 0xc0, 0x0a, 0x0a, 0x09, 0x46, 0x73, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	,
...
var file_fs_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_fs_manager_proto_goTypes = []any{
	...
	(*InstallAndExtractFileRequest)(nil), // 21: fsmanager.InstallAndExtractFileRequest
	(*UninstallServerRequest)(nil),       // 22: fsmanager.UninstallServerRequest
	(*GetDiskSpaceRequest)(nil),          // 23: fsmanager.GetDiskSpaceRequest
	(*GetDiskSpaceResponse)(nil),         // 24: fsmanager.GetDiskSpaceResponse
...
var file_fs_manager_proto_depIdxs = []int32{
	...
	21, // 15: fsmanager.FsManager.InstallAndExtractFile:input_type -> fsmanager.InstallAndExtractFileRequest
	22, // 16: fsmanager.FsManager.UninstallServer:input_type -> fsmanager.UninstallServerRequest
	23, // 17: fsmanager.FsManager.GetDiskSpace:input_type -> fsmanager.GetDiskSpaceRequest
	0,  // 18: fsmanager.FsManager.GetFileData:input_type -> fsmanager.GetFileDataRequest
	2,  // 19: fsmanager.FsManager.SetFileData:input_type -> fsmanager.SetFileDataRequest
	5,  // 20: fsmanager.FsManager.GetFileStat:output_type -> fsmanager.GetFileStatResponse
	7,  // 21: fsmanager.FsManager.ListFilePath:output_type -> fsmanager.ListFilePathResponse
	25, // 22: fsmanager.FsManager.CreatePath:output_type -> google.protobuf.Empty
	10, // 23: fsmanager.FsManager.DownloadFile:output_type -> fsmanager.DownloadFileResponse
	10, // 24: fsmanager.FsManager.BulkDownloadFile:output_type -> fsmanager.DownloadFileResponse
	12, // 25: fsmanager.FsManager.UploadFile:output_type -> fsmanager.UploadFileResponse
	25, // 26: fsmanager.FsManager.DeleteFile:output_type -> google.protobuf.Empty
	25, // 27: fsmanager.FsManager.RecoverFile:output_type -> google.protobuf.Empty
	25, // 28: fsmanager.FsManager.MoveFile:output_type -> google.protobuf.Empty
	25, // 29: fsmanager.FsManager.CopyFile:output_type -> google.protobuf.Empty
	25, // 30: fsmanager.FsManager.CompressFile:output_type -> google.protobuf.Empty
	25, // 31: fsmanager.FsManager.BulkCompressFile:output_type -> google.protobuf.Empty
	25, // 32: fsmanager.FsManager.InstallAndExtractFile:output_type -> google.protobuf.Empty
	25, // 33: fsmanager.FsManager.UninstallServer:output_type -> google.protobuf.Empty
	24, // 34: fsmanager.FsManager.GetDiskSpace:output_type -> fsmanager.GetDiskSpaceResponse
	1,  // 35: fsmanager.FsManager.GetFileData:output_type -> fsmanager.GetFileDataResponse
	3,  // 36: fsmanager.FsManager.SetFileData:output_type -> fsmanager.SetFileDataResponse
...
func file_fs_manager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fs_manager_proto_msgTypes[21].Exporter = func(v any, i int) any {
			switch v := v.(*InstallAndExtractFileRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fs_manager_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*UninstallServerRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fs_manager_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*GetDiskSpaceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fs_manager_proto_msgTypes[24].Exporter = func(v any, i int) any {
			switch v := v.(*GetDiskSpaceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
