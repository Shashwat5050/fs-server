...
var file_fs_manager_proto_rawDesc = []byte{
	...
	0x73, 0x44, 0x69, 0x72, 0x32, 0xa1, 0x07, 0x0a, 0x09, 0x46, 0x73, 0x4d, 0x61, 0x6e, 0x61, 0x67,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x2d, 0x5a, 0x2b, 0x69, 0x63, 0x65, 0x6c,
...
var file_fs_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_fs_manager_proto_goTypes = []interface{}{
	(*GetFileStatRequest)(nil),      // 0: fsmanager.GetFileStatRequest
	(*GetFileStatResponse)(nil),     // 1: fsmanager.GetFileStatResponse
	(*ListFilePathRequest)(nil),     // 2: fsmanager.ListFilePathRequest
	(*ListFilePathResponse)(nil),    // 3: fsmanager.ListFilePathResponse
	(*DownloadFileRequest)(nil),     // 4: fsmanager.DownloadFileRequest
	(*BulkDownloadFileRequest)(nil), // 5: fsmanager.BulkDownloadFileRequest
	(*DownloadFileResponse)(nil),    // 6: fsmanager.DownloadFileResponse
	(*UploadFileRequest)(nil),       // 7: fsmanager.UploadFileRequest
	(*UploadFileResponse)(nil),      // 8: fsmanager.UploadFileResponse
	(*FileInfo)(nil),                // 9: fsmanager.FileInfo
	(*DirEntry)(nil),                // 10: fsmanager.DirEntry
	(*DeleteFileRequest)(nil),       // 11: fsmanager.DeleteFileRequest
	(*RecoverFileRequest)(nil),      // 12: fsmanager.RecoverFileRequest
	(*TwoFileRequest)(nil),          // 13: fsmanager.TwoFileRequest
	(*CompressFileRequest)(nil),     // 14: fsmanager.CompressFileRequest
	(*BulkCompressFileRequest)(nil), // 15: fsmanager.BulkCompressFileRequest
	(*CreatePathRequest)(nil),       // 16: fsmanager.CreatePathRequest
	(*empty.Empty)(nil),             // 17: google.protobuf.Empty
}
var file_fs_manager_proto_depIdxs = []int32{
	9,  // 0: fsmanager.GetFileStatResponse.stat:type_name -> fsmanager.FileInfo
	10, // 1: fsmanager.ListFilePathResponse.fileList:type_name -> fsmanager.DirEntry
	9,  // 2: fsmanager.DirEntry.info:type_name -> fsmanager.FileInfo
	0,  // 3: fsmanager.FsManager.GetFileStat:input_type -> fsmanager.GetFileStatRequest
	2,  // 4: fsmanager.FsManager.ListFilePath:input_type -> fsmanager.ListFilePathRequest
	16, // 5: fsmanager.FsManager.CreatePath:input_type -> fsmanager.CreatePathRequest
	4,  // 6: fsmanager.FsManager.DownloadFile:input_type -> fsmanager.DownloadFileRequest
	5,  // 7: fsmanager.FsManager.BulkDownloadFile:input_type -> fsmanager.BulkDownloadFileRequest
	7,  // 8: fsmanager.FsManager.UploadFile:input_type -> fsmanager.UploadFileRequest
	11, // 9: fsmanager.FsManager.DeleteFile:input_type -> fsmanager.DeleteFileRequest
	12, // 10: fsmanager.FsManager.RecoverFile:input_type -> fsmanager.RecoverFileRequest
	13, // 11: fsmanager.FsManager.MoveFile:input_type -> fsmanager.TwoFileRequest
	13, // 12: fsmanager.FsManager.CopyFile:input_type -> fsmanager.TwoFileRequest
	14, // 13: fsmanager.FsManager.CompressFile:input_type -> fsmanager.CompressFileRequest
	15, // 14: fsmanager.FsManager.BulkCompressFile:input_type -> fsmanager.BulkCompressFileRequest
	1,  // 15: fsmanager.FsManager.GetFileStat:output_type -> fsmanager.GetFileStatResponse
	3,  // 16: fsmanager.FsManager.ListFilePath:output_type -> fsmanager.ListFilePathResponse
	17, // 17: fsmanager.FsManager.CreatePath:output_type -> google.protobuf.Empty
	6,  // 18: fsmanager.FsManager.DownloadFile:output_type -> fsmanager.DownloadFileResponse
	6,  // 19: fsmanager.FsManager.BulkDownloadFile:output_type -> fsmanager.DownloadFileResponse
	8,  // 20: fsmanager.FsManager.UploadFile:output_type -> fsmanager.UploadFileResponse
	17, // 21: fsmanager.FsManager.DeleteFile:output_type -> google.protobuf.Empty
	17, // 22: fsmanager.FsManager.RecoverFile:output_type -> google.protobuf.Empty
	17, // 23: fsmanager.FsManager.MoveFile:output_type -> google.protobuf.Empty
	17, // 24: fsmanager.FsManager.CopyFile:output_type -> google.protobuf.Empty
	17, // 25: fsmanager.FsManager.CompressFile:output_type -> google.protobuf.Empty
	17, // 26: fsmanager.FsManager.BulkCompressFile:output_type -> google.protobuf.Empty
...
func file_fs_manager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_fs_manager_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fs_manager_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
