...
const (
	Authorization_GetUserPermission_FullMethodName = "/authorization.Authorization/GetUserPermission"
)
...
type AuthorizationClient interface {
	GetUserPermission(ctx context.Context, in *jwt.JWT, opts ...grpc.CallOption) (*UserPermission, error)
}
...
func (c *authorizationClient) GetUserPermission(ctx context.Context, in *jwt.JWT, opts ...grpc.CallOption) (*UserPermission, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserPermission)
	err := c.cc.Invoke(ctx, Authorization_GetUserPermission_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorizationServer interface {
	GetUserPermission(context.Context, *jwt.JWT) (*UserPermission, error)
...
func (UnimplementedAuthorizationServer) GetUserPermission(context.Context, *jwt.JWT) (*UserPermission, error) {
...
func _Authorization_GetUserPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(jwt.JWT)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServer).GetUserPermission(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Authorization_GetUserPermission_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).GetUserPermission(ctx, req.(*jwt.JWT))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Authorization_GetUserPermission_Handler,
		},
	},
